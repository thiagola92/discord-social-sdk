...
int64_t DiscordInt16Array::get(int64_t p_index) {
	{
...
void DiscordInt16Array::set(int64_t p_index, int64_t value) {
	{
...
void DiscordInt16Array::_bind_methods() {
	{
		ClassDB::bind_method(D_METHOD("get", "index"),
				&DiscordInt16Array::get);

		ClassDB::bind_method(D_METHOD("set", "index", "value"),
				&DiscordInt16Array::set);
