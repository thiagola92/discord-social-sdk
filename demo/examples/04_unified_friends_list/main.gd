...
func display_friends_list() -> void:
	...
	for relationship in client.GetRelationships():
		...
		string += " DiscordRelationshipType: %s" % Discordpp.EnumToStringRelationshipType(relationship.DiscordRelationshipType())
		string += " GameRelationshipType: %s" % Discordpp.EnumToStringRelationshipType(relationship.GameRelationshipType())
